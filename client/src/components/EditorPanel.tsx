        ...
        <div className='space-y-4 text-black'>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <div>
                    ...
                    <input type='text' value={values.styles.margin} onChange={(e)=>handleStyleChange('fontSize',e.target.value)} className='w-full text-sm p-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none'/>
                </div>
            </div>  
            <div className='grid grid-cols-2 gap-3'>
                <div>
